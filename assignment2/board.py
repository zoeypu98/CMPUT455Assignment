...
class GoBoard(object):
    ...
    def play_tempmove(self, state, move, color):
        """
        Play a temporary legal move of color on a board copy point
        move: index i.e 3x3 board, position a1 is move 13
        """
        state.board[move] = color
        state.current_player = GoBoardUtil.opponent(color)
        return

    def undo_tempmove(self, state, move, color):
